...
echo "EXT4-fs (sda1): mounting ext3 file system using the ext4 subsystem"
echo "EXT4-fs (sda1): mounted filesystem with ordered data mode. Opts: (null)"

echo "root@linaro-nano:~# dd if=/dev/urandom of=/mnt/hd0/file-350mb bs=1M count=350"
dd if=/dev/urandom of=/mnt/hd0/file-350mb bs=1M count=350

echo "root@linaro-nano:~# time cp /mnt/hd0/file-350mb /tmp/temp;time umount /mnt/hd0"
{ time cp /mnt/hd0/file-350mb /tmp/temp; } 2> log_cp.txt
