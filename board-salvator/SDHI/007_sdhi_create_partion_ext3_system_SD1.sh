...
( echo d; echo 1; echo d; echo 2; echo d; echo 3; echo d; echo n; echo p; echo 1; echo 2048; echo "+1500MB"; echo t; echo 83; echo w) | fdisk $DEVICE_SD1 > /dev/null 2>&1 

echo "Make ext3 file system for partion 1"
mkfs.ext3 ${DEVICE_SD1}p1 > /dev/null 2>&1

if [ ! -e "${DEVICE_SD1}p1" ]; then
