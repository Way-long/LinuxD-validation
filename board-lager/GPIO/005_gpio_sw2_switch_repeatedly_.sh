...
echo "switch the key repeatedly then check interrupt counting"
...
#wait user action
$(dirname $0)/../common/wait_user_action.sh "Please switch SW1,SW2,SW3,SW4 on/off REPEATEDLY then input \"next\" to continue..." "next"
